...
@section('title', 'Editar horario - BarberShop')
...
<section class="max-w-5xl mx-auto">
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-ink-600">
                Actualiza la información del horario, sus días asignados y su estado.
            </p>
        </div>
    ...
    <div class="rounded-panel border border-cream-200 bg-white shadow-card">
        ...
        <form method="POST" action="{{ route('horario.update', $horario->id) }}" class="p-6 sm:p-8 space-y-8">
            @csrf
            @method('PUT')
            ...
            <div>
                <div class="mb-5 border-b border-cream-200 pb-4">
                    ...
                    <p class="mt-1 text-sm text-ink-600">
                        Modifica el nombre, descripción, rango de horas y estado del horario.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input
                            ...
                            id="nombre_horario"
                            name="nombre_horario"
                            value="{{ old('nombre_horario', $horario->nombre_horario) }}"
                            required
                    ...
                    <div>
                        ...
                        <select
                            ...
                            class="w-full px-4 py-3 rounded-card border border-cream-300 bg-white text-ink focus:border-barber-red focus:outline-none focus:ring-4 focus:ring-barber-red-100 transition-colors"
                        >
                            <option value="1" {{ (string) old('estado', (int) $horario->estado) === '1' ? 'selected' : '' }}>
                                Activo
                            </option>

                            <option value="0" {{ (string) old('estado', (int) $horario->estado) === '0' ? 'selected' : '' }}>
                                Inactivo
                            </option>
                        </select>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea
                            ...
                            name="descripcion"
                            rows="4"
                            placeholder="Ejemplo: Horario principal para barberos del turno matutino."
                        ...
                        >{{ old('descripcion', $horario->descripcion) }}</textarea>
            ...
            <div>
                ...
                @php
                    $diasSeleccionados = old('dias', $horario->diasSemana->pluck('id')->toArray());
                @endphp
