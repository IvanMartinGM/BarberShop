...
@section('title', 'Editar barbero - BarberShop')
@section('page-title', 'Editar barbero')
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-ink-600">
                Actualiza la información personal y profesional del barbero.
            </p>
        </div>
            ...
            <div>
                <div class="mb-5 border-b border-cream-200 pb-4">
                    ...
                    <p class="mt-1 text-sm text-ink-600">
                        Datos básicos de la cuenta del barbero.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="F" {{ old('genero', $barbero->user?->genero) === 'F' ? 'selected' : '' }}>
                                Femenino
                            </option>
                            <option value="otro" {{ old('genero', $barbero->user?->genero) === 'otro' ? 'selected' : '' }}>
                                Otro
                            </option>
                        </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="ocupado" {{ old('estado_disponibilidad', $barbero->estado_disponibilidad) === 'ocupado' ? 'selected' : '' }}>
                                Ocupado
                            </option>
                            <option value="inactivo" {{ old('estado_disponibilidad', $barbero->estado_disponibilidad) === 'inactivo' ? 'selected' : '' }}>
                                Inactivo
                            </option>
                        </select>
