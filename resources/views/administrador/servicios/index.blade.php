                                ...
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    @if ($servicio->estado == 1)
                                        <form method="POST"
                                              ...
                                              onsubmit="return confirm('¿Seguro que deseas desactivar este servicio? Ya no será elegible para que los barberos lo seleccionen.');">
                                            @csrf
                                            @method('DELETE')
                                            ...
                                            <button
                                                ...
                                                class="inline-flex h-10 w-10 items-center justify-center rounded-card border border-danger bg-white text-danger hover:bg-danger hover:text-white transition-colors"
                                            >
                                                🗑
                                            </button>
                                        </form>
                                    @else
                                        <span
                                            ...
                                            class="inline-flex h-10 w-10 items-center justify-center rounded-card border border-cream-300 bg-cream-100 text-ink-500"
                                        >
                                            —
                                        </span>
                                    @endif
                    ...
                    <div class="mt-4 flex flex-wrap justify-end gap-2">
                        ...
                        @if ($servicio->estado == 1)
                            <form method="POST"
                                ...
                                <button
                                    type="submit"
                                    class="inline-flex items-center justify-center rounded-card border border-danger bg-white px-4 py-2 text-sm font-bold text-danger hover:bg-danger hover:text-white transition-colors"
                                >
                                    Desactivar
                                </button>
                            </form>
