...
<section class="max-w-5xl mx-auto">
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex flex-col sm:flex-row gap-3">
            ...
            <a href="{{ route('servicio.index') }}"
               class="inline-flex items-center justify-center rounded-panel bg-cream-200 px-5 py-3 text-sm font-bold text-navy hover:bg-cream-300 transition-colors">
                Lista de servicios
            </a>
    ...
    <div class="rounded-panel border border-cream-200 bg-white shadow-card">
        ...
        <form method="POST" action="{{ route('servicio.update', $servicio->id) }}" class="p-6 sm:p-8 space-y-8">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="precio_base"
                            name="precio_base"
                            value="{{ old('precio_base', number_format((float) $servicio->precio_base, 2, '.', '')) }}"
                            required
                            min="0"
                            max="999999.99"
                            step="0.01"
