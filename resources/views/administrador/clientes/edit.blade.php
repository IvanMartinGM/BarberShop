...
<section class="max-w-5xl mx-auto">
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a href="{{ route('cliente.show', $cliente->id) }}" class="inline-flex items-center justify-center rounded-panel border border-cream-300 bg-white px-5 py-3 text-sm font-bold text-navy hover:bg-cream-100 transition-colors">
            Volver al perfil
        </a>
    </div>
    ...
    <div class="rounded-panel border border-cream-200 bg-white shadow-card">
        ...
        <form method="POST" action="{{ route('cliente.update', $cliente->id) }}" class="p-6 sm:p-8 space-y-8">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nombres" name="nombres" value="{{ old('nombres', $cliente->user?->nombres) }}" required placeholder="Ivan Martin" class="w-full px-4 py-3 rounded-card border border-cream-300 bg-white text-ink placeholder:text-ink-500 focus:border-barber-red focus:outline-none focus:ring-4 focus:ring-barber-red-100 transition-colors">
                    ...
                    <div>
                        ...
                        <input type="text" id="primer_apellido" name="primer_apellido" value="{{ old('primer_apellido', $cliente->user?->primer_apellido) }}" required placeholder="Gomez" class="w-full px-4 py-3 rounded-card border border-cream-300 bg-white text-ink placeholder:text-ink-500 focus:border-barber-red focus:outline-none focus:ring-4 focus:ring-barber-red-100 transition-colors">
                    ...
                    <div>
                        ...
                        <input type="tel" id="celular" name="celular" value="{{ old('celular', $cliente->user?->celular) }}" placeholder="+52 333 456 7890" class="w-full px-4 py-3 rounded-card border border-cream-300 bg-white text-ink placeholder:text-ink-500 focus:border-barber-red focus:outline-none focus:ring-4 focus:ring-barber-red-100 transition-colors">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email', $cliente->user?->email) }}" required placeholder="cliente@email.com" class="w-full px-4 py-3 rounded-card border border-cream-300 bg-white text-ink placeholder:text-ink-500 focus:border-barber-red focus:outline-none focus:ring-4 focus:ring-barber-red-100 transition-colors">
            ...
            <div class="flex flex-col-reverse sm:flex-row sm:justify-end gap-3 border-t border-cream-200 pt-6">
                ...
                <a href="{{ route('cliente.show', $cliente->id) }}" class="inline-flex items-center justify-center rounded-panel bg-cream-200 px-6 py-3 text-sm font-bold text-navy hover:bg-cream-300 transition-colors">
                    Cancelar
                </a>
