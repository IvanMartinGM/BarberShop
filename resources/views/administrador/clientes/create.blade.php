...
@section('title', 'Agregar cliente - BarberShop')
...
<section class="max-w-5xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="mt-2 text-sm text-ink-600">
            Crea el usuario del cliente y completa su información.
        </p>
    </div>
        ...
        <form method="POST" action="{{ route('cliente.store') }}" class="p-6 sm:p-8 space-y-8">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" required placeholder="cliente@email.com" class="w-full px-4 py-3 rounded-card border border-cream-300 bg-white text-ink placeholder:text-ink-500 focus:border-barber-red focus:outline-none focus:ring-4 focus:ring-barber-red-100 transition-colors">
                        @error('email')
                        <p class="text-sm text-barber-red mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div>
                <div class="mb-5 border-b border-cream-200 pb-4">
                    ...
                    <p class="mt-1 text-sm text-ink-600">
                        Define la contraseña inicial del cliente.
                    </p>
                </div>
